...
export class CatalogueService {
  ...
  get_highlight() {
    ...
    return this.httpClient.get(environment.statistic_url+"/statistic/topitem?nitems=6");
  }

  get_highCat(){
    console.log("http://localhost:14080/statistic/topcat?ncategories=3");
    return this.httpClient.get(environment.statistic_url+"/statistic/topcat?ncategories=3");
  }

  get_highCatItem(cat: string){
    console.log("http://localhost:14080/statistic/topitemcat?category="+cat+"&nitems=3");
    return this.httpClient.get(environment.statistic_url+"/statistic/topitemcat?category="+cat+"&nitems=3");
  }
