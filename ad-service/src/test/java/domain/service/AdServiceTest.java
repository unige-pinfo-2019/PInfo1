...
public class AdServiceTest {
	...
	public static String addAnnonce(String userID, String name, String categorie, String state) 
	{
...
//	            Class.forName("com.mysql.jdbc.Driver").newInstance();
    ...
    public static void main(String[] args) {	
    	...
    	String name = "Etagère";
    	String categorie = "Mobilier";
    	String state = "Neuf";
    	String WantedID = addAnnonce(userId,name,categorie,state);
